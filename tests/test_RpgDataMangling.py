"""unit test for RpgDataMangling.py
...
The idea behind unit testing is to call this script and have it test
a series of individual aspects of the file named in the first line.
...
class KnownValues(unittest.TestCase):
    ...
    def test_get_number_of_dice(self):
        ...
        expect = 2
        result = RpgDataMangling.parse_dice("2d6+3")[0]
    ...
    def test_get_type_of_dice(self):
        ...
        expect = 6
        result = RpgDataMangling.parse_dice("2d6+3")[1]
        self.assertEqual(expect, result)
    ...
    def test_get_bonus_of_dice(self):
        ...
        expect = 3
        result = RpgDataMangling.parse_dice("2d6+3")[2]
        self.assertEqual(expect, result)
    ...
    def test_get_big_number_of_dice(self):
        ...
        expect = 22
        result = RpgDataMangling.parse_dice("22d20+31")[0]
        self.assertEqual(expect, result)
    ...
    def test_get_big_type_of_dice(self):
        ...
        expect = 20
        result = RpgDataMangling.parse_dice("22d20+31")[1]
        self.assertEqual(expect, result)
    ...
    def test_get_big_bonus_of_dice(self):
        ...
        expect = 31
        result = RpgDataMangling.parse_dice("22d20+31")[2]
        self.assertEqual(expect, result)
    ...
    def test_get_type_of_dice_no_bonus(self):
        ...
        expect = 12
        result = RpgDataMangling.parse_dice("3d12")[1]
        self.assertEqual(expect, result)
    ...
    def test_get_number_of_dice_no_bonus(self):
        ...
        expect = 3
        result = RpgDataMangling.parse_dice("3d12")[0]
        self.assertEqual(expect, result)
    ...
    def test_get_type_of_dice_no_bonus_upper(self):
        ...
        expect = 8
        result = RpgDataMangling.parse_dice("4D8")[1]
        self.assertEqual(expect, result)
    ...
    def test_get_number_of_dice_no_bonus_upper(self):
        ...
        expect = 4
        result = RpgDataMangling.parse_dice("4D8")[0]
        self.assertEqual(expect, result)
